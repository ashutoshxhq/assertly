...
import { RiAddLargeLine, RiArrowDownSLine, RiArrowLeftSLine, RiArrowRightSLine, RiCheckLine, RiEqualizer2Line, RiPlayLargeFill, RiQuestionLine, RiSendPlane2Line } from "react-icons/ri"
        ...
        <div className="flex flex-col py-2 gap-2">
            <div className="flex justify-between items-center px-2">
                ...
                <div className="flex  w-[33.33%] justify-center">
                    <div className="px-4 py-2 rounded-md bg-neutral-800 text-sm text-neutral-300"><span className="font-semibold lowercase">Webassert</span> / Untitled Test Spec</div>
                </div>
            ...
            <ResizablePanelGroup direction="horizontal" className="flex px-2">
                <ResizablePanel className="p-[1px]" defaultSize={30}>
                    <div className="flex rounded-lg shadow-sm ring-1 ring-neutral-950/4 dark:bg-neutral-950 dark:ring-white/5 text-neutral-300 h-[calc(100vh-62px)] overflow-y-scroll">
                            ...
                            <TabsContent value="steps" className="w-full overflow-y-scroll">
                                <div className="py-4 flex flex-col gap-2 w-full">
                                    <div className="flex w-full bg-neutral-800 rounded-md">
                                        <Collapsible className="w-full" open={stepCollapsible[0]} onOpenChange={(open) => {
                                            ...
                                            <CollapsibleContent className="w-full">
                                                <div className="w-full flex flex-col border-t border-neutral-700/40 p-4">
                                                    <TestTypeSelector />
                                                </div>
                                            </CollapsibleContent>
                                        </Collapsible>
                                    ...
                                    <div className="w-full flex justify-center items-center mt-4">
                                        <div className="border-t border-neutral-800 flex-1 mr-2"></div>
                                        <Button variant={"brand"} className="px-8"><RiAddLargeLine className="mr-2" /> Add New Step</Button>
                                        <div className="border-t border-neutral-800 flex-1 ml-2"></div>
                                ...
                                <div className="flex flex-col w-full h-full flex-1 overflow-hidden">
                                    <div className="flex-1 overflow-scroll text-sm flex flex-col gap-6 py-4">
                                        ...
                                        <div className="flex items-start gap-4 justify-end">
                                            <div className="bg-primary p-3 rounded-lg max-w-[90%] bg-neutral-800">
                                                <p>I'm looking to create a new chat UI for my app. Can you help me with that?</p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-1">
                                            <Avatar className="w-8 h-8 border border-neutral-600">
                                    ...
                                    <div className="bg-card bottom-0 flex items-center gap-2 bg-neutral-900 rounded-[30px] min-h-14 mt-2">
                                        <Textarea
                ...
                <ResizablePanel className="p-[1px] ml-2" defaultSize={70}>
                    <ResizablePanelGroup direction="vertical" className="flex flex-col">
                        <ResizablePanel defaultSize={70} className="p-[1px]">
                            <div className="flex flex-1 flex-col h-full grow rounded-lg shadow-sm ring-1 ring-neutral-950/4 dark:bg-neutral-950 dark:ring-white/5 text-neutral-300 overflow-y-scroll">
                                <div className="flex justify-between items-center p-2">
                                    ...
                                    <div className="flex">
                                        <div className="rounded-full flex items-center justify-center bg-neutral-800 px-8 py-1.5 w-80">
                                            <span className="text-xs text-neutral-300">https://google.com</span>
                                        </div>
                                    </div>
                                ...
                                <div className="lex flex-1 bg-neutral-500 w-full h-">
                        ...
                        <ResizablePanel defaultSize={30} className="p-[1px] mt-2">
                            <div className="flex flex-1 p-2 h-full grow rounded-lg shadow-sm ring-1 ring-neutral-950/4 dark:bg-neutral-950 dark:ring-white/5 text-neutral-300 overflow-y-scroll">
