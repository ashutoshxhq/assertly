...
{
  "steps": [
    // Array of step objects following the schema
  ],
  "message": "A short consise message to the user asknowledging them, do not include explaination of steps here. This is just a message to the user. This message should be as if you are replying to the user."
}

Ensure that both the steps and message are included in your response.
`;
};
