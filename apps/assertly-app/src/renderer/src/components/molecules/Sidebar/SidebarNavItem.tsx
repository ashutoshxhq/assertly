              ...
              <span className="relative">
                ...
                <div
                  className={cn(
                    ...
                    isActive && 'bg-zinc-100 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700'
                  )}
                >
                  <span className={cn('text-xl text-[22px]', !isActive && 'dark:text-zinc-400')}>{icon}</span>
                  <span className={cn('truncate hidden', !isActive && 'dark:text-zinc-200')}>{title}</span>
                </div>
              </span>
            </TooltipTrigger>
