  ...
  return (
    <div className="dark flex flex-col h-[100vh] bg-neutral-900">
      <div className="flex flex-1 w-full bg-neutral-900">
        <div className="relative isolate flex w-full bg-white lg:bg-neutral-100 dark:bg-neutral-900 ">
          <Sidebar/>
          <main className="flex flex-1 flex-col pb-3 min-w-0 pl-[70px] pr-3 pt-3" data-tauri-drag-region>
            <div className="grow rounded-lg shadow-sm ring-1 ring-neutral-950/4 dark:bg-neutral-950 dark:ring-white/5 text-neutral-300 h-[calc(100vh-24px)] overflow-y-scroll">
              <Outlet />
            </div>
          </main>
        </div>
