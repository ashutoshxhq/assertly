...
import { authAtom, registerMutationAtom } from "src/store/auth/auth";
    ...
    return (
        <>
            <div className="dark h-screen w-screen flex bg-zinc-900">
                ...
                <div
                    className="relative flex-1 max-w-[40%] h-full flex-col border-zinc-800 bg-zinc-200 text-white hidden md:flex dark:border-r"
