...
export const userFlows: UserFlow[] = [
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "s6", type: "assertion", description: "Verify order confirmation", details: { selector: ".order-confirmed" } }
        ],
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "s4", type: "assertion", description: "Verify confirmation message", details: { selector: ".confirmation-msg" } }
        ],
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "s5", type: "assertion", description: "Verify review posted", details: { selector: ".review-confirmation" } }
        ],
        tags: ["product", "review"],
        createdBy: "user404",
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "s4", type: "assertion", description: "Verify subscription message", details: { selector: ".subscription-confirmed" } }
        ],
    ...
    },
    {
        ...
        steps: [
            ...
            { id: "s5", type: "assertion", description: "Verify discount applied", details: { selector: ".discount-applied" } }
        ],
