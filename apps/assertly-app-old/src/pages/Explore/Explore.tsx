                ...
                <div className="flex-1 overflow-auto p-10 space-y-4">
                    ...
                    <div className="flex items-start gap-4 justify-end">
                        <div className="bg-primary p-3 rounded-lg max-w-[70%] dark:bg-zinc-800">
                            <p>
                                I'm looking to create a new chat UI for my app.
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="bg-card p-3 rounded-lg max-w-[70%]">
                            <p>
                                Yes, I'd be happy to help you with that. What
                                kind of features are you looking for in the chat
                                UI?
                            </p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 justify-end">
                        <div className="bg-primary p-3 rounded-lg max-w-[70%] dark:bg-zinc-800">
                            <p>
                                I'd like a clean and modern design, with the
                                ability to send messages, view past
                                conversations, and maybe even some basic
                                formatting options.
                            </p>
                        </div>
                    </div>
