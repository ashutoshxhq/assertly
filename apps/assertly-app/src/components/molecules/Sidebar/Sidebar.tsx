...
const Sidebar = () => {
    ...
    return (
        <div
            className="fixed inset-y-0 left-0 w-[70px] h-[calc(100vh)] overflow-y-hidden z-50"
        ...
        >
            ...
            >
                ...
                <div
                    className="flex flex-1 flex-col overflow-y-auto [&amp;>[data-slot=section]+[data-slot=section]]:mt-8"
                    data-tauri-drag-region
                >
                    <div
                        data-slot="section"
